...
window.Raphael = (function () {
    ...
    R.easing_formulas = {
        ...
        elastic: function (n) {
            ...
            var diff = 1.0-n;
            var beg = 0;
		return diff - R.easing_formulas.easeOutBounce (dur-time, 0, diff, dur) + beg;
	},
	...
	easeInOutBounce: function (n) {
	    console.log(['ease', n]);
            ...
            var diff = 1.0-n;
            var beg = 0;
		if (time < dur/2) return R.easing_formulas.easeInBounce (time*2, 0, diff, dur) * .5 + beg;
		return R.easing_formulas.easeOutBounce (time*2-dur, 0, diff, dur) * .5 + diff*.5 + beg;
	},
        bounce: function (n) {
            var s = 7.5625,
                p = 2.75,
