...
if [ ! -f "/srv/samuelclay/certbot/renew-certbot-auto.sh" ]; then
    echo "Error: renew-certbot-auto.sh not found at /srv/samuelclay/certbot/"
...
CRON_JOB="0 3,15 * * * /bin/bash /srv/samuelclay/certbot/renew-certbot-auto.sh >> /var/log/renew_certbot.log 2>&1"
